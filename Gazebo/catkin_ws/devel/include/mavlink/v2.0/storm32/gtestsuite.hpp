...
TEST(storm32, COMPONENT_PREARM_STATUS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::storm32::msg::COMPONENT_PREARM_STATUS packet_in{};
    packet_in.target_system = 29;
    packet_in.target_component = 96;
    packet_in.enabled_flags = 963497464;
    packet_in.fail_flags = 963497672;

    mavlink::storm32::msg::COMPONENT_PREARM_STATUS packet1{};
    mavlink::storm32::msg::COMPONENT_PREARM_STATUS packet2{};
    ...
    EXPECT_EQ(packet1.target_system, packet2.target_system);
    EXPECT_EQ(packet1.target_component, packet2.target_component);
    EXPECT_EQ(packet1.enabled_flags, packet2.enabled_flags);
    EXPECT_EQ(packet1.fail_flags, packet2.fail_flags);
}

#ifdef TEST_INTEROP
TEST(storm32_interop, COMPONENT_PREARM_STATUS)
{
    mavlink_message_t msg;
    ...
    mavlink_component_prearm_status_t packet_c {
    ...
    mavlink_msg_component_prearm_status_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.target_system, packet2.target_system);
    EXPECT_EQ(packet_in.target_component, packet2.target_component);
    EXPECT_EQ(packet_in.enabled_flags, packet2.enabled_flags);
    EXPECT_EQ(packet_in.fail_flags, packet2.fail_flags);
