...
"""autogenerated by genpy from mavros_msgs/ESCTelemetry.msg. Do not edit."""
import codecs
import sys
...
class ESCTelemetry(genpy.Message):
  _md5sum = "7b1fb252ca6aa175fe8dd23d029b3362"
  _type = "mavros_msgs/ESCTelemetry"
...
"""
  ...
  _slot_types = ['std_msgs/Header','mavros_msgs/ESCTelemetryItem[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ESCTelemetry, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.esc_telemetry is None:
        self.esc_telemetry = []
    else:
      self.header = std_msgs.msg.Header()
      self.esc_telemetry = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.esc_telemetry)
      buff.write(_struct_I.pack(length))
      for val1 in self.esc_telemetry:
        _v1 = val1.header
        _x = _v1.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = mavros_msgs.msg.ESCTelemetryItem()
        _v3 = val1.header
        start = end
        end += 4
        ...
        self.esc_telemetry.append(val1)
      return self
