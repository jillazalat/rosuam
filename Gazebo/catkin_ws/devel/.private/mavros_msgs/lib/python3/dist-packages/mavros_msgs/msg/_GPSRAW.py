...
class GPSRAW(genpy.Message):
  _md5sum = "58a85dbc1516a2d4302f256cca54bbbf"
...
"""
  ...
  _slot_types = ['std_msgs/Header','uint8','int32','int32','int32','uint16','uint16','uint16','uint16','uint8','int32','uint32','uint32','uint32','int32','uint16','uint8','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,fix_type,lat,lon,alt,eph,epv,vel,cog,satellites_visible,alt_ellipsoid,h_acc,v_acc,vel_acc,hdg_acc,yaw,dgps_numch,dgps_age
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_B3i4HBi3IiHBI().pack(_x.fix_type, _x.lat, _x.lon, _x.alt, _x.eph, _x.epv, _x.vel, _x.cog, _x.satellites_visible, _x.alt_ellipsoid, _x.h_acc, _x.v_acc, _x.vel_acc, _x.hdg_acc, _x.yaw, _x.dgps_numch, _x.dgps_age))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.fix_type, _x.lat, _x.lon, _x.alt, _x.eph, _x.epv, _x.vel, _x.cog, _x.satellites_visible, _x.alt_ellipsoid, _x.h_acc, _x.v_acc, _x.vel_acc, _x.hdg_acc, _x.yaw, _x.dgps_numch, _x.dgps_age,) = _get_struct_B3i4HBi3IiHBI().unpack(str[start:end])
      return self
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_B3i4HBi3IiHBI = None
def _get_struct_B3i4HBi3IiHBI():
    global _struct_B3i4HBi3IiHBI
    if _struct_B3i4HBi3IiHBI is None:
        _struct_B3i4HBi3IiHBI = struct.Struct("<B3i4HBi3IiHBI")
    return _struct_B3i4HBi3IiHBI
