...
if("TRUE" STREQUAL "TRUE")
  set(iq_sim_SOURCE_PREFIX /home/moe/catkin_ws/src/iq_sim)
  set(iq_sim_DEVEL_PREFIX /home/moe/catkin_ws/devel/.private/iq_sim)
  set(iq_sim_INSTALL_PREFIX "")
  set(iq_sim_PREFIX ${iq_sim_DEVEL_PREFIX})
else()
  set(iq_sim_SOURCE_PREFIX "")
  set(iq_sim_DEVEL_PREFIX "")
  set(iq_sim_INSTALL_PREFIX /home/moe/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'iq_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/moe/catkin_ws/src/iq_sim/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/moe/catkin_ws/devel/.private/iq_sim/lib;/home/moe/catkin_ws/devel/lib;/opt/ros/noetic/lib)
