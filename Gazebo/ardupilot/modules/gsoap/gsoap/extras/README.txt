...
This 'extras' directory contains useful additions.
...
fault.cpp contributed by A. Kelly (MPL1.1 licensed)
soapdefs.h and logging.cpp contributed by M. Helmick (MPL1.1 licensed)
